  ...
  <div class="content-wrapper">
   ...
   صفحه المستخدم
    ...
    <section class="content">
     ...
     <strong><i class="fa fa-file-text-o margin-r-5"></i>تقيم</strong>
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal" method="post" action="{{url('/storeinfor')}}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control"  name="name" id="inputName" placeholder="الاسم">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="inputName"  class="col-sm-2 control-label">العمر</label>
...
<div class="form-group">
  <label for="inputName" class="col-sm-2 control-label">العنوان</label>

  <div class="col-sm-10">
    <input type="text" class="form-control" id="inputName"  name="adress"placeholder="العنوان">
  </div>
</div>

<div class="form-group">
  <label for="inputName"   class="col-sm-2 control-label">رقم الهاتف</label>

  <div class="col-sm-10">
    <input type="text" class="form-control" name="number" id="inputName" placeholder="رقم الهاتف">
  </div>
</div>
